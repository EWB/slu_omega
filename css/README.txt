...
To use these stylesheets, rename the files and slu_omega with the name of your theme.
...
slu_omega-alpha-default-narrow.css  
...
slu_omega-alpha-default-normal.css
...
slu_omega-alpha-default-wide.css
